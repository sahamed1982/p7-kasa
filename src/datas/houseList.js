export const housetList = [
	...
	},
	{
		...
		"description": "Votre maison au loin. au bout du monde, mais à quelques stations de RER, vous vous sentirez chez vous dans notre appartement.",
		"host": {
			"name": "Stéphane Jugeot",
			"picture": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-12.jpg"
		},
		"rating": "5",
		"location": "Ile de France - Paris 4e",
		"equipments": [
			"Équipements de base",
			"Micro-Ondes",
			"Douche italienne",
